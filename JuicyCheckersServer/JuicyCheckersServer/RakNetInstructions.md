...
# Download RakNet API
I have built Raknet and jave put it in the Google Drive below is the direct link
	https://drive.google.com/open?id=0BxJ4eq4VJ59CN1l5THM5UDhSSFU
	
	In this .zip file is the entire RakNet folder place this in a suitable location such as C:/DEV/
